...
urlpatterns = [
    ...
    path('student/profile_image/', views_student_profile.student_profile_image, name='student_profile_image'),
    path('student/profile_update/', views_student_profile.student_profile_update, name='student_profile_update'),
